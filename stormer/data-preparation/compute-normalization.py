# https://github.com/tung-nd/stormer/blob/main/stormer/data_preprocessing/compute_normalization.py
...
def parse_args():
    ...
    parser.add_argument('--lead-time', type=int, default=None, help='Lead time for difference normalization.')  # None means we're computing normalization for the original data
    parser.add_argument('--data-frequency', type=int, default=6, help='Data frequency in hours (default=6).')  # this depends on the dataset
